...
#matpath=path.expand("./raw/abccbids/fmriresults01/derivatives/abcd-hcp-pipeline/sub-NDARINV9X1R94EZ/ses-baselineYear1Arm1/func")
#matfile=file.path(matpath,"sub-NDARINV9X1R94EZ_ses-baselineYear1Arm1_task-rest_desc-filtered_motion_mask.mat")
